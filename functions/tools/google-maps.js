...
exports.handler = async function (context, event, callback) {
  ...
  let place_id = searchData.candidates[0].place_id;

  const detailsResponse = await fetch(
    `https://maps.googleapis.com/maps/api/place/details/json?fields=name%2Ccurrent_opening_hours%2Cformatted_address%2Cformatted_phone_number&place_id=${place_id}&key=${context.GOOGLE_MAPS_API_KEY}`
  );
